function plotFunc_timecourse(Sim::Module,n_file::Int64,viz_type::String,show_all::Bool,stdev::Bool,
    ...
    subplot(2,4,1);
    plot(Sim.t,Sim.PMEK_cyt[:,1],"mediumblue");
    plot(Sim.t,Sim.PMEK_cyt[:,2],"red");
    e = errorbar(Exp.t2/60.,Exp.egf_MEKc_av,yerr=Exp.egf_MEKc_se,lw=1,
        markerfacecolor="None",markeredgecolor="mediumblue",ecolor="mediumblue",fmt="D",capsize=8,clip_on=false);
    for b in e[2]
        b.set_clip_on(false);
    end
    e = errorbar(Exp.t2/60.,Exp.hrg_MEKc_av,yerr=Exp.hrg_MEKc_se,lw=1,
        markerfacecolor="None",markeredgecolor="red",ecolor="red",fmt="s",capsize=8,clip_on=false);
    for b in e[2]
        b.set_clip_on(false);
    end
    xlim(0,90);
    ...
    if show_all
        for i=1:n_file
            plot(Sim.t,PERK_cyt_all[i,:,1]./maximum(PERK_cyt_all[i,:,:]),"mediumblue",alpha=0.05);
            plot(Sim.t,PERK_cyt_all[i,:,2]./maximum(PERK_cyt_all[i,:,:]),"red",alpha=0.05);
        end
    end
    if viz_type != "average"
        plot(Sim.t,Sim.PERK_cyt[:,1]./maximum(Sim.PERK_cyt),"mediumblue");
        plot(Sim.t,Sim.PERK_cyt[:,2]./maximum(Sim.PERK_cyt),"red");
    else
        ...
        plot(Sim.t,vec(mean(PERK_cyt_norm[:,:,1],dims=1)),"mediumblue");
        plot(Sim.t,vec(mean(PERK_cyt_norm[:,:,2],dims=1)),"red");
        if stdev
    ...
    if show_all
        for i=1:n_file
            plot(Sim.t,PRSK_wcl_all[i,:,1]./maximum(PRSK_wcl_all[i,:,:]),"mediumblue",alpha=0.05);
            plot(Sim.t,PRSK_wcl_all[i,:,2]./maximum(PRSK_wcl_all[i,:,:]),"red",alpha=0.05);
        end
    end
    if viz_type != "average"
        plot(Sim.t,Sim.PRSK_wcl[:,1]./maximum(Sim.PRSK_wcl),"mediumblue");
        plot(Sim.t,Sim.PRSK_wcl[:,2]./maximum(Sim.PRSK_wcl),"red");
    else
        ...
        plot(Sim.t,vec(mean(PRSK_wcl_norm[:,:,1],dims=1)),"mediumblue");
        plot(Sim.t,vec(mean(PRSK_wcl_norm[:,:,2],dims=1)),"red");
        if stdev
    ...
    if show_all
        for i=1:n_file
            plot(Sim.t,PCREB_wcl_all[i,:,1]./maximum(PCREB_wcl_all[i,:,:]),"mediumblue",alpha=0.05);
            plot(Sim.t,PCREB_wcl_all[i,:,2]./maximum(PCREB_wcl_all[i,:,:]),"red",alpha=0.05);
        end
    end
    if viz_type != "average"
        plot(Sim.t,Sim.PCREB_wcl[:,1]./maximum(Sim.PCREB_wcl),"mediumblue");
        plot(Sim.t,Sim.PCREB_wcl[:,2]./maximum(Sim.PCREB_wcl),"red");
    else
        ...
        plot(Sim.t,vec(mean(PCREB_wcl_norm[:,:,1],dims=1)),"mediumblue");
        plot(Sim.t,vec(mean(PCREB_wcl_norm[:,:,2],dims=1)),"red");
        if stdev
    ...
    if show_all
        for i=1:n_file
            plot(Sim.t,DUSPmRNA_all[i,:,1]./maximum(DUSPmRNA_all[i,:,:]),"mediumblue",alpha=0.05);
            plot(Sim.t,DUSPmRNA_all[i,:,2]./maximum(DUSPmRNA_all[i,:,:]),"red",alpha=0.05);
        end
    end
    if viz_type != "average"
        plot(Sim.t,Sim.DUSPmRNA[:,1]./maximum(Sim.DUSPmRNA),"mediumblue");
        plot(Sim.t,Sim.DUSPmRNA[:,2]./maximum(Sim.DUSPmRNA),"red");
    else
        ...
        plot(Sim.t,vec(mean(DUSPmRNA_norm[:,:,1],dims=1)),"mediumblue");
        plot(Sim.t,vec(mean(DUSPmRNA_norm[:,:,2],dims=1)),"red");
        if stdev
    ...
    if show_all
        for i=1:n_file
            plot(Sim.t,cFosmRNA_all[i,:,1]./maximum(cFosmRNA_all[i,:,:]),"mediumblue",alpha=0.05);
            plot(Sim.t,cFosmRNA_all[i,:,2]./maximum(cFosmRNA_all[i,:,:]),"red",alpha=0.05);
        end
    end
    if viz_type != "average"
        plot(Sim.t,Sim.cFosmRNA[:,1]./maximum(Sim.cFosmRNA),"mediumblue");
        plot(Sim.t,Sim.cFosmRNA[:,2]./maximum(Sim.cFosmRNA),"red");
    else
        ...
        plot(Sim.t,vec(mean(cFosmRNA_norm[:,:,1],dims=1)),"mediumblue");
        plot(Sim.t,vec(mean(cFosmRNA_norm[:,:,2],dims=1)),"red");
        if stdev
    ...
    if show_all
        for i=1:n_file
            plot(Sim.t,cFosPro_all[i,:,1]./maximum(cFosPro_all[i,:,:]),"mediumblue",alpha=0.05);
            plot(Sim.t,cFosPro_all[i,:,2]./maximum(cFosPro_all[i,:,:]),"red",alpha=0.05);
        end
    end
    if viz_type != "average"
        plot(Sim.t,Sim.cFosPro[:,1]./maximum(Sim.cFosPro),"mediumblue");
        plot(Sim.t,Sim.cFosPro[:,2]./maximum(Sim.cFosPro),"red");
    else
        ...
        plot(Sim.t,vec(mean(cFosPro_norm[:,:,1],dims=1)),"mediumblue");
        plot(Sim.t,vec(mean(cFosPro_norm[:,:,2],dims=1)),"red");
        if stdev
    ...
    if show_all
        for i=1:n_file
            plot(Sim.t,PcFos_all[i,:,1]./maximum(PcFos_all[i,:,:]),"mediumblue",alpha=0.05);
            plot(Sim.t,PcFos_all[i,:,2]./maximum(PcFos_all[i,:,:]),"red",alpha=0.05);
        end
    end
    if viz_type != "average"
        plot(Sim.t,Sim.PcFos[:,1]./maximum(Sim.PcFos),"mediumblue");
        plot(Sim.t,Sim.PcFos[:,2]./maximum(Sim.PcFos),"red");
    else
        ...
        plot(Sim.t,vec(mean(PcFos_norm[:,:,1],dims=1)),"mediumblue");
        plot(Sim.t,vec(mean(PcFos_norm[:,:,2],dims=1)),"red");
        if stdev
    ...
    #show();
    savefig("./Fig/simulation_$viz_type.png",dpi=300,bbox_inches="tight");
