...
experiments[species["Phosphorylated_CREBw"]] = Dict(
    "EGF" => [0,0.446,0.030,0.000,0.000],
    "HRG" => [0,1.000,0.668,0.460,0.340]
);
standardError[species["Phosphorylated_CREBw"]] = Dict(
...
function getTimepoint(observalbe::Int)
    ...
    elseif observalbe == species["Phosphorylated_CREBw"]
        return t3
    
    elseif observalbe == species["cfos_mRNA"]
        return t4
