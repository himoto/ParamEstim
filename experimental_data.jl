...
standard_error[observables_index("Phosphorylated_MEKc")] = Dict(
...
standard_error[observables_index("Phosphorylated_ERKc")] = Dict(
...
standard_error[observables_index("Phosphorylated_RSKw")] = Dict(
...
standard_error[observables_index("Phosphorylated_cFos")] = Dict(
...
standard_error[observables_index("Phosphorylated_CREBw")] = Dict(
...
standard_error[observables_index("cfos_mRNA")] = Dict(
...
standard_error[observables_index("cFos_Protein")] = Dict(
...
standard_error[observables_index("dusp_mRNA")] = Dict(
