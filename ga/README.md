...
## v2/gaV2:
gaV2 optimizes an objective function through the following procedure.
...
To achieve a good search performance, gaV2 optimizes a function, gradually narrowing the search space. For this purpose, the converging phase slightly converges the population by repeating the following procedure *N<sub>iter</sub>* times.
